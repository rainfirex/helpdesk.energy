...
<!--                </div>-->
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="department" aria-describedby="departmentHelp" v-model="department"
                           :class="{'error-input': $v.department.$error}"
                           @change="$v.department.$touch"
                    >
                    <small id="departmentHelp" class="form-text text-muted" :class="{'is-error': $v.department.$error}">Отдел заявителя.
                        <span v-if="!$v.department.required"  class="error-text" :class="{'error-show': !$v.department.required}">Поле пустое</span>
                        <span v-if="!$v.department.minLength" class="error-text" :class="{'error-show': !$v.department.minLength}">Минимум 6 символа</span>
                    </small>
                </div>
                ...
                <div class="form-group">
                    ...
                    >
                    <small id="phoneHelp" class="form-text text-muted" :class="{'is-error': $v.phone.$error}">Номер телефона для обратной связи.
                ...
                <div class="form-group">
                    ...
                    >
                    <small id="titleHelp" class="form-text text-muted" :class="{'is-error': $v.title.$error}">Название заявки.
                ...
                <div class="form-group">
                    ...
                    <small id="categoryHelp" class="form-text text-muted" :class="{'is-error': $v.category.$error}">Категория заявки.
                        <span v-if="!$v.category.required" class="error-text" :class="{'error-show': !$v.category.required}">Поле пустое</span>
                    </small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small id="descriptionHelp" class="form-text text-muted" :class="{'is-error': $v.description.$error}">Основной текст заявки.
                        ...
                        <span v-if="!$v.description.minLength" class="error-text" :class="{'error-show': !$v.description.minLength}">Минимум 4 символа</span>
                    </small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" multiple @change="selectFiles" accept=".jpg, .jpeg, .png">
